...
class PolymarketClient:
    ...
    def __init__(self, private_key: str = None, api_key: str = None, secret: str = None, passphrase: str = None):
        ...
        if all([private_key, api_key, secret, passphrase]):
            ...
            logger.warning("CLOB client initialized without authentication (Read-only).")
    ...
    async def get_order_book(self, token_id: str):
        ...
        # Public fallback
        response = await self.client.get(f"https://clob.polymarket.com/book", params={"token_id": token_id})
